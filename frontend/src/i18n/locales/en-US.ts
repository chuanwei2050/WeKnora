export default {
  ...
  knowledgeGraphExplore: {
    ...
    empty: 'No knowledge graph data yet. Enable entity extraction and finish document processing.',
    emptyPie: 'No data',
  ...
  graphSettings: {
    ...
    rebuildDescription: 'Clear this knowledge base graph and re-enqueue extraction for completed documents.',
    rebuildConfirm: 'Clear and rebuild the knowledge graph? This cannot be undone.',
    rebuildSuccess: 'Knowledge graph cleared; enqueued extraction for {n} documents',
