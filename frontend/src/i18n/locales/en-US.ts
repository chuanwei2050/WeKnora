export default {
  ...
  workbench: {
    title: 'Workbench',
    subtitle: 'Review answer feedback, graph triples, and acceptance runs.',
    tabs: {
      feedback: 'Answer Feedback',
      graphTriples: 'Graph Review',
      acceptance: 'Acceptance',
    },
  },
  knowledgeGraphExplore: {
    tab: 'Knowledge Graph',
    siderTitle: 'Knowledge Graph',
    panorama: 'Panorama Graph',
    collapseMenu: 'Collapse menu',
    searchPlaceholder: 'Search entities or documents…',
    typePlaceholder: 'Node type',
    ...
    refresh: 'Refresh',
    export: 'Export graph',
    exportJson: 'Export JSON (nodes & edges)',
    exportCsv: 'Export CSV (nodes & edges)',
    exportPng: 'Export PNG image',
    exportJsonSuccess: 'Graph JSON exported',
    exportCsvSuccess: 'Graph CSV exported',
    loadFailed: 'Failed to load knowledge graph',
    empty: 'No graph data yet. Finish extraction; if review is on, approve triples first.',
    emptyPie: 'No data',
    statsTitle: 'Graph statistics',
    statsKnowledge: 'Docs {n}',
    statsEntity: 'Entities {n}',
    statsEdge: 'Edges {n}',
    statsKnowledgeLabel: 'Document nodes',
    statsEntityLabel: 'Concepts',
    statsEdgeLabel: 'Relations',
    statsRelatedLabel: 'Entity relations',
    statsMentionLabel: 'Document mentions',
    statsTagLabel: 'Tags',
    statsCanvasEdges: 'Canvas edges',
    truncated: 'Truncated (~300 entities); use search to narrow',
    resultLimited: 'Truncated (~300 entities); use search to narrow',
    legendKnowledge: 'Document',
    legendEntity: 'Concept',
    legendPerson: 'Person',
    legendOrg: 'Organization',
    legendTag: 'Tag',
    legendMentions: 'Mentions',
    legendRelated: 'Related',
    legendAnnotation: 'Annotation',
    canvasHint: 'Drag nodes, scroll to zoom; click a node for details',
    typeDistTitle: 'Concept type distribution',
    selectedTitle: 'Current node',
    topEntities: 'Top concepts TOP5',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
  ...
  knowledgeBase: {
    ...
    files: 'Files',
    settings: 'Settings',
    documentCategoryTitle: 'Knowledge categories',
    ...
    allDocumentsFolder: 'All documents',
    folderTitle: 'Folders',
    publicFilesFolder: 'Public knowledge',
    publicFolderCreateAction: 'New public folder',
    childFolderCreateAction: 'New subfolder',
    folderExpandAction: 'Expand subfolders',
    folderCollapseAction: 'Collapse subfolders',
    folderCreateAction: 'New folder',
    folderSearchPlaceholder: 'Search folders',
    folderRenameAction: 'Rename',
    folderSearchLabel: 'Search',
    folderSearchDisabledByParent: 'Search is disabled for the parent folder, so this setting is not currently active',
    ...
    folderOrderIncomplete: 'Too many folders to reorder in this view',
    moveToFolder: 'Move to folder',
    adjustKnowledgeCategory: 'Move to category',
    batchMoveFolderSuccess: 'Moved {count} documents to “{name}”',
    batchMoveFolderFailed: 'Failed to move documents',
    tagLabel: 'Category',
    ...
    existingFileLocation: 'Existing document location: {location}',
    ...
    documentDirectoryRoot: 'Root',
    newDocumentDirectory: 'New folder',
    renameDocumentDirectory: 'Rename folder',
    deleteDocumentDirectory: 'Delete folder',
    documentCount: '{count} documents',
    moveToDocumentDirectory: 'Move to folder',
    downloadDocumentDirectory: 'Download folder',
    confirmDirectoryDeleteImpact: 'Delete {directories} folder(s) and {documents} document(s). This runs asynchronously and cannot be undone.',
    directoryDeleteAccepted: 'Folder deletion task submitted',
    directoryDeleteFailed: 'Folder deletion failed. Please retry.',
    sortName: 'Name',
    ...
    batchStopParse: 'Batch Stop',
    rebuildConfirmBatch: 'Rebuild {count} selected documents? Existing chunks will be cleared and parsed again.',
    rebuildSubmittedBatch: 'Rebuild submitted for {count} documents',
    rebuildSubmittedBatchPartial: 'Rebuild submitted for {success} documents, {failed} failed',
    stopParseConfirm: 'Stop parsing "{fileName}"? Chunks, vectors, queue tasks and other parse artifacts will be cleaned up. The document itself remains as failed and can be rebuilt later.',
    stopParseConfirmBatch: 'Stop parsing {count} selected documents? Chunks, vectors, queue tasks and other parse artifacts will be cleaned up. Documents remain as failed and can be rebuilt later.',
    stopParseSubmitted: 'Parsing stopped',
    stopParseSubmittedBatch: 'Stopped parsing for {count} documents',
    stopParseFailed: 'Failed to stop parsing. Please try again later',
    draft: 'Draft',
    ...
    batchGovernanceSuccess: '{action} succeeded for {count} items',
    batchGovernancePartial: '{success} succeeded and {failed} failed; failed items remain selected',
    ...
    statusDraft: 'Draft',
    governanceSubmit: 'Submit',
    governanceWithdraw: 'Withdraw',
    governanceApprove: 'Approve',
    governanceReject: 'Reject',
    governanceRejectCommentRequired: 'Rejection requires a comment',
    governanceRejectCommentPlaceholder: 'Enter rejection reason',
    governanceDelete: 'Delete',
    rowEdit: 'Edit',
    rowRebuild: 'Rebuild',
    rowMove: 'Move to folder',
    rowMoveToDirectory: 'Move to folder',
    rowMoveToCategory: 'Move to category',
    governanceSubmitSuccess: 'Submitted for approval',
    governanceWithdrawSuccess: 'Submission withdrawn',
    governanceApproveSuccess: 'Submission approved',
    governanceRejectSuccess: 'Submission rejected',
    governanceVersionMissing: 'Pending version not found. Refresh and try again.',
    governanceActionFailed: 'Action failed',
    ...
    pdfDocFormat: 'Supports pdf, doc, docx and more',
    textMarkdownFormat: 'Supports txt, markdown and more',
  ...
  agent: {
    ...
    toolFallback: 'Tool',
    stepsCompleted: 'Completed {steps} step(s)',
    stepsCompletedWithDuration: 'Completed {steps} step(s) in {duration}',
    title: 'Agents',
    ...
    editor: {
      ...
      embeddingTopK: 'Fusion Candidate Count',
      vectorRecallTopK: 'Vector Recall Count',
      keywordRecallTopK: 'Keyword Recall Count',
      rrfVectorWeight: 'RRF Weights (Vector / Keyword)',
      keywordThreshold: 'Keyword Threshold',
      vectorThreshold: 'Vector Threshold',
      rerankTopK: 'Rerank Top K',
      rerankCandidateTopK: 'Rerank Candidate Count',
  ...
  settings: {
    ...
    apiInfo: 'API Info',
    graphTripleReview: {
      nav: 'Graph Triple Review',
      feedbackNav: 'Answer Feedback Review',
      acceptanceNav: 'Acceptance Benchmarks',
      title: 'Graph Triple Review',
      description: 'Review extracted entity-relation candidates before they are written to the graph. Independent from knowledge-version governance.',
      refresh: 'Refresh',
      loading: 'Loading triple candidates…',
      empty: 'No graph triple review items.',
      emptyPending: 'No pending graph triples',
      emptyFiltered: 'No review items for this filter',
      emptyHint: 'Extracted entity relations appear here after knowledge processing. Approved items are written to the graph.',
      countLabel: '{n} items',
      relationCount: '{n} relations',
      entityCount: '{n} entities',
      knowledgeBase: 'Knowledge base',
      chunkLabel: 'Chunk',
      noRelations: 'No relations to display',
      loadFailed: 'Failed to load graph triple list',
      approve: 'Approve & write',
      approveConfirm: 'This will write the triples to the graph. Continue?',
      reject: 'Reject',
      rejectTitle: 'Reject this candidate',
      rejectCommentLabel: 'Reason (optional)',
      rejectCommentPlaceholder: 'Add a note for later troubleshooting',
      approveSuccess: 'Written to graph',
      approveFailed: 'Approve failed (candidate stays pending for retry)',
      rejectSuccess: 'Rejected',
      rejectFailed: 'Reject failed',
      selectAll: 'Select all',
      batchApprove: 'Approve selected',
      batchReject: 'Reject selected',
      batchApproveConfirm: 'Approve and write {n} items to the graph?',
      batchRejectTitle: 'Reject {n} items',
      batchApproveSuccess: 'Approved {n} items',
      batchRejectSuccess: 'Rejected {n} items',
      batchPartial: '{ok} succeeded, {failed} failed (failed items restored as pending)',
      statusPending: 'Pending',
    ...
    weknoraCloud: {
      ...
      usageSteps: '1. Fill in and save APPID and APPSECRET on this page\n2. Model services: Go to Model Management, add a model with Remote API source, select CloudService as provider\n3. Document parsing: Go to Knowledge Base Settings → Parser Engine, select Cloud Service engine for desired file types',
      ...
      credentialConfigured: 'CloudService credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'CloudService credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'CloudService credentials configured. See supported models in',
    ...
    storage: {
      ...
      approvedEndpointLabel: 'Approved private endpoint',
      approvedEndpointPlaceholder: 'Select an administrator-approved object storage endpoint',
      publicEndpointOption: 'Public endpoint (online mode)',
  ...
  webSearchSettings: {
    ...
    approvedEndpointLabel: 'Approved private endpoint',
    approvedEndpointPlaceholder: 'Select an administrator-approved search endpoint',
    publicEndpointOption: 'Public endpoint (online mode)',
    approvedEndpointHelp: 'Strict air-gapped mode requires a registered endpoint approved for query use; proxies cannot be combined with it.',
    apiKeyLabel: 'API Key',
  ...
  retrievalSettings: {
    navLabel: 'Retrieval Strategy',
    title: 'Retrieval Strategy',
    description: 'Configure the platform retrieval budget shared by chat, agents, and integrations',
    queryExpansionLabel: 'Query Expansion',
    queryExpansionDescription: 'Allow routing to expand queries when needed; disabling this prevents expansion in every entry point',
    embeddingTopKLabel: 'Fusion Candidate Count',
    embeddingTopKDescription: 'Number of candidates kept after merging vector and keyword results',
    vectorRecallTopKLabel: 'Vector Recall Count',
    vectorRecallTopKDescription: 'Maximum vector results recalled before fusion',
    keywordRecallTopKLabel: 'Keyword Recall Count',
    keywordRecallTopKDescription: 'Maximum keyword results recalled before fusion',
    rrfVectorWeightLabel: 'RRF Vector Weight',
    rrfVectorWeightDescription: 'Balance vector and keyword result weights during fusion',
    ...
    rerankCandidateTopKLabel: 'Rerank Candidate Count',
    rerankCandidateTopKDescription: 'Number of candidates sent to the rerank model',
    ...
    batchProtectionTitle: 'Integration Batch Search Protection',
    batchProtectionDescription: 'Configure per-query retention and total response limits for batch search',
    batchRerankTopKLabel: 'Batch Rerank Top K per Query',
    batchRerankTopKDescription: 'Maximum results returned after reranking for each search-batch query',
    batchMaxResultsLabel: 'Batch Total Result Limit',
    batchMaxResultsDescription: 'Maximum number of deduplicated results returned by one search-batch request',
    batchMaxContentCharsLabel: 'Batch Content Character Limit',
    batchMaxContentCharsDescription: 'Maximum total Unicode characters across all search-batch result content',
    ...
    fallbackTitle: 'Answer Fallback',
    fallbackDescription: 'Used only by quick answers when no valid retrieval evidence is found',
    fallbackStrategyLabel: 'Fallback Strategy',
    fallbackStrategyDescription: 'Return fixed content or let the model continue with a prompt',
    fallbackFixed: 'Fixed response',
    fallbackModel: 'Use model',
    fallbackResponseLabel: 'Fallback Response',
    fallbackResponseDescription: 'Fixed content returned when no valid retrieval result is available',
    fallbackResponsePlaceholder: 'Enter a fixed fallback response',
    fallbackPromptLabel: 'Fallback Prompt',
    fallbackPromptDescription: 'Prompt used to guide the model; supports query and language placeholders',
    fallbackPromptPlaceholder: 'Enter the fallback prompt',
    toasts: {
      saveSuccess: 'Retrieval configuration saved',
      fallbackSaveSuccess: 'Answer fallback configuration saved',
      saveFailed: 'Failed to save configuration: {message}',
    },
  },
  graphSettings: {
    title: 'Knowledge Graph Configuration',
    description: 'Extract entities and relations into the knowledge graph (distinct from the Wiki page graph).',
    enableLabel: 'Enable Entity-Relationship Extraction',
    enableDescription: 'Applies only to newly processed or rebuilt documents.',
    rebuildLabel: 'Rebuild knowledge graph',
    rebuildDescription: 'Clears the existing graph and re-extracts with the current config. Cannot be undone.',
    rebuildConfirm: 'Clear and rebuild the knowledge graph? This cannot be undone.',
    rebuildStarted: 'Enqueued {n} documents; rebuild started…',
    rebuildSuccess: 'Graph cleared; enqueued extraction for {n} documents',
    rebuildQueuedReview: 'Graph cleared; enqueued {n} documents. Triple review is ON.',
    rebuildRunning: 'Rebuilding: {done}/{total} extract tasks done',
    rebuildAwaitingReview: 'Extraction finished. {n} triples await review before writing to the graph.',
    rebuildCompletedAt: 'Rebuild completed ({time})',
    rebuildFailed: 'Failed to rebuild knowledge graph',
    extractModeLabel: 'Extraction mode',
    extractModeDescription: 'General auto-extract; template prefills; custom fully defines the schema.',
    modeGeneral: 'General extraction',
    modeTemplate: 'Use template',
    modeCustom: 'Custom schema',
    templateLabel: 'Configuration template',
    templateDescription: 'After applying, you can still edit the schema and examples.',
    entitySchemaLabel: 'Entity type schema',
    entitySchemaDescription: 'Constrains which entity types may be extracted and what they mean.',
    relationSchemaLabel: 'Relation type schema',
    relationSchemaDescription: 'Constrains relation types and source → target direction.',
    addEntityType: 'Add entity type',
    addRelationType: 'Add relation type',
    entityTypeNamePlaceholder: 'Name',
    entityBaseTypePlaceholder: 'Type',
    schemaDescriptionPlaceholder: 'Description',
    advancedSettingsTitle: 'Advanced extraction settings',
    exampleSettingsTitle: 'Extraction examples and testing (optional)',
    tagsLabel: 'Relation Types (Whitelist)',
    tagsDescription: 'Only these relation types are kept. Leave empty to allow other relations. Use stable English identifiers.',
    tagsPlaceholder: 'Enter relation types, e.g., uses, tests, supports',
    entityTypesLabel: 'Entity Types (Whitelist)',
    entityTypesDescription: 'entity_types is the entity-type whitelist; under strict schema, unknown or empty types are rejected',
    entityTypesPlaceholder: 'Enter entity types, e.g., tool, metric, defect',
    strictSchemaLabel: 'Keep Whitelisted Types Only',
    strictSchemaDescription: 'Requires both relation and entity-type whitelists; results outside them are discarded.',
    requireTripleReviewLabel: 'Require human triple review',
    requireTripleReviewDescription: 'Writes to the graph only after approval; rebuild also enters the review queue when enabled.',
    openTripleReview: 'Open Triple Review',
    rulesLabel: 'Ingest & Graph Search Rules',
    rulesDescription: 'Ingest scope is controlled above. Whether to search the graph at Q&A time is decided automatically.',
    generalExtractionTemplate: 'General extraction (any domain)',
    softwareTestingTemplate: 'Software Testing',
    applyTemplate: 'Apply Template',
    templateLoaded: 'Graph template applied. Every field remains editable.',
    defaultsHint: 'Templates only prefill the schema and few-shot example; they are never bound automatically.',
    sampleTextLabel: 'Few-shot Sample Text',
    sampleTextDescription: 'For model demonstration only; not written to the graph.',
    sampleTextPlaceholder: 'Enter natural domain text with explicit entities and relationships...',
    generateRandomText: 'Generate Test Text from Relations',
    entityListLabel: 'Expected Entities (Few-shot Output)',
    entityListDescription: 'Expected entities for the sample text — not entities already in the graph.',
    relationListLabel: 'Expected Relations (Few-shot Output)',
    relationListDescription: 'Expected relations for the sample text — not relations already in the graph.',
    extractActionsLabel: 'Dry run',
    extractActionsDescription: 'Tests the current config only; does not write to the graph.',
    ingestionModeLabel: 'Ingest scope',
    ingestionModeDescription: '“Relation-signal only” processes chunks with clear relation cues.',
    ingestionModeAll: 'All non-empty text (recommended)',
    ingestionModeSignal: 'Relation-signal text only',
    extractionLimitsLabel: 'Extraction quality limits',
    extractionLimitsDescription: 'Caps graph size per chunk and filters low-confidence relations.',
    maxEntitiesLabel: 'Max entities',
    maxRelationsLabel: 'Max relations',
    minConfidenceLabel: 'Min relation confidence',
    extractionModelLabel: 'Graph extraction model',
    extractionModelDescription: 'Falls back to the knowledge-base summary model if unset',
    useFallbackModel: 'Use knowledge-base summary model',
    nodeNamePlaceholder: 'Enter entity name',
    nodeTypePlaceholder: 'Select entity type',
    aliasesPlaceholder: 'Enter one or more aliases',
    ...
    startExtraction: 'Try Extraction',
    ...
    extractFailedWithReason: 'Entity-relationship extraction failed: {reason}',
    extractSummary: 'Try extraction complete: kept {entities} entities and {relations} relations after current whitelist, limit, and confidence filters.',
  ...
  initialization: {
    ...
    welcome: 'Welcome to Knowledge QA Agent',
  ...
  file: {
    ...
    downloading: 'Writing file {progress}% (do not open it until complete)',
  ...
  knowledgeEditor: {
    ...
    reprocess: {
      ...
      confirmBody: 'This clears current chunks and derived data, reparses completed or failed documents, and rebuilds summaries, chunk questions, Elasticsearch, vector indexes, and the enabled knowledge graph. Pending or processing documents are not queued twice. Search results may be incomplete while processing. Continue?',
    ...
    maintenance: {
      ...
      stop: 'Stop rebuild',
      stopSubmitted: 'Rebuild stopped: in-flight documents were interrupted and maintenance is unlocked',
      stopFailed: 'Failed to stop rebuild',
      stopAllParses: 'Stop All Parsing',
      stopAllParsesConfirm: 'Stop {count} documents currently parsing? Chunks, vectors, queue tasks and other parse artifacts will be cleaned up. Documents remain as failed and can be rebuilt later.',
      stopAllParsesSubmitted: 'Stopped parsing for {count} documents',
      stopAllParsesFailed: 'Failed to stop all parsing',
      statusLoadFailed: 'Could not load rebuild progress',
      statusLoadFailedHint: 'The backend is busy or the request timed out. A job may still be running—retry instead of starting another one.',
      retryStatus: 'Reload',
      canceling: 'Stopping rebuild: {processed}/{total} finished.',
      forceUnlock: 'Force unlock',
      canceled: 'Rebuild stopped: in-flight documents were interrupted. Completed results were kept, and maintenance is unlocked.',
      ...
      actions: {
        reparse: { label: 'Rebuild All', description: 'One-click full pipeline: reparse every document and rebuild summaries, chunk questions, keyword/ES, vectors, structured data, and the enabled graph. Use “Stop All Parsing” to interrupt documents currently being parsed.' },
...
\
      ...
      inheritHeadingLabel: 'Inherit section headings',
      inheritHeadingDescription: 'Prepend Markdown heading paths into subsequent chunks for better retrieval. Applies to new imports/rebuilds only; does not auto re-embed the whole library.',
  ...
  chat: {
    ...
    graphPathsShow: 'Show graph reasoning paths',
    graphPathsHide: 'Hide graph reasoning paths',
  ...
  error: {
    ...
    requestTimeout: 'Request timed out. Preview can be slow for large knowledge bases — please try again.',
  ...
  model: {
    ...
    editor: {
      ...
      validatingVision: 'Validating vision capability…',
      visionValidationSuccess: 'Vision capability validated successfully',
      ...
      validatingThinking: 'Validating deep-thinking capability…',
      thinkingValidationSuccess: 'Deep-thinking capability validated successfully',
  ...
  modelSettings: {
    ...
    modelProfile: {
      title: 'Model profile checklist',
      profileLabel: 'Current PROFILE',
      airGappedOn: 'Strict air-gap ON',
      airGappedOff: 'Strict air-gap OFF',
      invalidProfile: 'Invalid PROFILE; comparing as online',
      summary: 'Gaps: missing env {missingEnv} · unregistered {missingReg} · mismatch {mismatch} · ok {ok}',
      disclaimer: 'Changing MODEL_PROFILE does not switch live traffic. Rebind models here. Expected names must match registered name (use served_model_name with model-scripts).',
      expand: 'Show role checklist',
      collapse: 'Hide role checklist',
      expected: 'Expected',
      statusOk: 'OK',
      statusMissingEnv: 'Missing env',
      statusMissingReg: 'Unregistered',
      statusMismatch: 'Mismatch',
      actionAdd: 'Add',
      actionEdit: 'Edit',
      fillEnvFirst: 'Fill .env first',
      loadFailed: 'Failed to load profile status',
      builtinCannotEdit: 'Matched a builtin model that cannot be edited here; use a tenant-owned model or adjust the env expected name'
    },
    actions: {
      addModel: 'Add Model',
  ...
  preview: {
    ...
    originalPartialPreviewHint: 'Only the first 30 original pages are shown. Use the download button beside the file name to view the complete document.',
    partialPreviewGenerating: 'Generating the first 30 original pages in the background…',
    partialPreviewFailed: 'Failed to generate partial preview',
  },
  knowledgeSearch: {
    title: 'Search',
  ...
  agentEditor: {
    ...
    desc: {
      ...
      responseStrategy: 'Configure no-match response behavior',
      queryExpansion: 'Automatically expand query terms to improve recall',
      embeddingTopK: 'Maximum number of candidates kept after vector and keyword fusion',
      vectorRecallTopK: 'Maximum vector results retrieved before fusion',
      keywordRecallTopK: 'Maximum keyword results retrieved before fusion',
      rrfVectorWeight: 'Vector and keyword weights used by RRF; their sum is fixed at 1',
      ...
      rerankCandidateTopK: 'Maximum fused candidates sent to the rerank model',
  ...
  feishuPublish: {
    ...
    description: 'Manually publish this knowledge base to a Feishu wiki (no schedule). On conflict, this knowledge base overwrites managed Feishu content.',
    viewGuide: 'View guide',
    guideTitle: 'Feishu sync setup guide',
    guideIntro: 'Follow each page below. Blue buttons open the related Feishu pages.',
    guide: {
      step1Title: '1. Create an enterprise app',
      step1Where: 'Page: Feishu Open Platform → Developer Console',
      step1Body: 'Click Create enterprise app (not store app / agent). Open Credentials & Basic Info and copy App ID (cli_…) and App Secret (reveal with the eye icon).',
      step1Link: 'Open Developer Console',
      step2Title: '2. Grant API scopes',
      step2Where: 'Page: App → Permissions → Enable (app identity)',
      step2Body: 'Enable at least: wiki:wiki, wiki:node:create, docx:document, drive:file, docs:document.media:upload. Scopes take effect only after you publish a version.',
      step2Link: 'Permission docs',
      step3Title: '3. Publish the app',
      step3Where: 'Page: App → Version & release',
      step3Body: 'Create version → fill notes → save → Confirm publish. Top status must become Enabled.',
      step4Title: '4. Enable bot capability',
      step4Where: 'Page: App → Add capabilities → Bot',
      step4Body: 'Enable Bot, then create and publish another version. Without this, wiki member search often cannot find the app.',
      step5Title: '5. Add the app to the wiki space',
      step5Where: 'Page: Feishu → target wiki → Settings → Members',
      step5Body: 'Add as admin/editor and search the app name. If not found: create a group, add the app as group bot, then add that group in members.',
      step5Link: 'Open Feishu Docs',
      step6Title: '6. Configure and sync here',
      step6Where: 'Page: This knowledge base → Settings → Sync to Feishu (this page)',
      step6Body: 'Enter App ID / Secret (spaces load automatically) → choose space & location → Preview & sync. After binding use Sync now; watch the progress bar. Retry failures from the details dialog. After success, open Feishu to verify.',
      step6Link: 'Open Feishu',
      treeTitle: 'Feishu tree after sync',
      treeBody: '<KB name>\n├── Public knowledge → tags → directories → docs\n├── Uncategorized\n├── Other non-public root tags\n└── _已归档 (deleted sources move here)',
      openConsole: 'Developer Console',
    },
    featureDisabled: 'Feishu knowledge sync is disabled. Please contact an administrator.',
    appId: 'App ID',
    appIdPlaceholder: 'cli_xxxx',
    appIdRequired: 'App ID is required',
    appSecret: 'App Secret',
    appSecretPlaceholder: 'Enter App Secret',
    appSecretTip: 'Saved secrets are never shown. Leave blank to keep the existing secret. Changing App ID requires a new secret.',
    appSecretRequired: 'App Secret is required',
    appSecretRequiredOnAppIdChange: 'Re-enter App Secret after changing App ID',
    secretConfigured: 'Configured',
    discoverSpaces: 'Fetch wiki spaces',
    discovering: 'Loading wiki spaces…',
    retryDiscover: 'Retry',
    discoverSuccess: 'Accessible wiki spaces loaded',
    noSpaces: 'No accessible wiki spaces for this app',
    permissionHint: 'Ensure Wiki API scopes are granted and add the app as a wiki space member via a group chat.',
    space: 'Target wiki space',
    spacePlaceholder: 'Select a wiki space',
    spaceLoading: 'Loading wiki spaces…',
    spaceFailedHint: 'Load failed — retry',
    spaceDisabledHint: 'Spaces load automatically after credentials',
    spaceRequired: 'Select a target wiki space',
    spaceLockedHint: 'Wiki space is locked. Unbind before switching to another space.',
    location: 'Sync location',
    locationTip: 'Choose the parent page for the managed home. Defaults to the wiki space root.',
    spaceRoot: 'Wiki space root',
    syncNow: 'Sync now',
    editConfig: 'Edit configuration',
    editingConfigHint: 'Editing Feishu sync configuration',
    previewSync: 'Preview & sync',
    retryFailures: 'Retry failures',
    retryFailuresHint: 'Another sync skips succeeded items and only retries failed, conflict, and blocked ones. Oversized files are skipped — compress and re-upload before syncing again.',
    errors: {
      fileTooLarge: 'File exceeds the single-file upload limit (currently 2GB). Retry will not help — compress or split the file and re-upload. Detail: {detail}',
    },
    previewTitle: 'Sync impact preview',
    previewIntro: 'Confirming will save the configuration and start an async sync.',
    previewNoChanges: 'No changes needed',
    previewWarnings: 'Notes:',
    confirmSync: 'Confirm sync',
    syncQueued: 'Sync task queued',
    impactChanged: 'Sync impact changed — please confirm again',
    activeRunWarning: 'A sync is already in progress. Try again later.',
    unbind: 'Unbind',
    unbindConfirm: 'Unbinding clears Feishu publish config and secrets for this knowledge base. Existing Feishu pages will not be deleted.',
    unbindSecondTitle: 'Confirm unbind again',
    unbindSecondBody: 'Feishu pages will not be deleted and will no longer be maintained. Continue?',
    ...
    stages: {
      ...
      ensure_home: 'Preparing managed home',
      executing: 'Syncing',
      done: 'Done',
      failed: 'Failed',
    },
    ...
    failuresTitle: 'Failures / conflicts',
    openInFeishu: 'Open in Feishu',
    spaceMoveTitle: 'Confirm location change',
    spaceMoveBody: 'The wiki space is locked. Changing the sync location moves the entire managed home. Continue?',
    spaceMoveConfirm: 'Confirm move',
    discardTitle: 'Discard unsaved changes?',
    discardBody: 'The Sync to Feishu tab has unsaved changes. Switching away or closing will discard them.',
