export default {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      codeLabel: 'Knowledge Base Code',
      codePlaceholder: 'Used to filter knowledge bases (optional)',
    ...
    messages: {
      ...
      codeInvalid: 'Use only letters, numbers, hyphens, and underscores (up to 64 characters)',
