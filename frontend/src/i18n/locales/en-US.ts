export default {
  ...
  graphSettings: {
    ...
    tagsDescription: 'Tags are the relation-type whitelist; when non-empty, unknown relation types are dropped on ingest/try-extract',
    ...
    strictSchemaLabel: 'Strict Schema',
    strictSchemaDescription: 'Require both Tags and entity_types, and hard-filter unknown entity types',
    ...
    loadSoftwareTestingPreset: 'Load Software-Testing Preset',
    presetLoaded: 'Software-testing entity/relation preset loaded',
    defaultsHint: 'New KBs and first-time extract enablement default to the software-testing Tags / entity_types with strict schema on',
