export default {
  ...
  knowledgeBase: {
    ...
    allDocumentsFolder: "모든 문서",
    folderTitle: "폴더",
    publicFilesFolder: "공용 지식",
    publicFolderCreateAction: "새 공용 폴더",
    childFolderCreateAction: "새 하위 폴더",
    folderExpandAction: "하위 폴더 펼치기",
    folderCollapseAction: "하위 폴더 접기",
    folderCreateAction: "새 폴더",
    folderSearchPlaceholder: "폴더 검색",
    folderRenameAction: "이름 변경",
    folderSearchLabel: "검색",
    folderSearchDisabledByParent: "상위 폴더에서 검색이 꺼져 있어 현재 설정이 적용되지 않습니다",
    folderDeleteAction: "삭제",
    folderDeleteNotEmpty: "폴더를 비운 후에만 삭제할 수 있습니다",
    uploadTarget: "업로드 위치: {name}",
    folderReorderSuccess: "폴더 순서가 저장되었습니다",
    folderReorderFailed: "폴더 순서를 저장하지 못했습니다",
    folderOrderIncomplete: "폴더가 너무 많아 순서를 변경할 수 없습니다",
    moveToFolder: "폴더로 이동",
    adjustKnowledgeCategory: "분류로 이동",
    batchMoveFolderSuccess: "문서 {count}개를 ‘{name}’ 폴더로 이동했습니다",
    batchMoveFolderFailed: "문서를 이동하지 못했습니다",
    tagLabel: "분류",
    ...
    fileExistsInFolder: "이 파일은 이미 '{folder}' 폴더에 있습니다.",
    existingFileLocation: "기존 문서 위치: {location}",
    locateExistingFile: "기존 파일 찾기",
    ...
    batchGovernanceSuccess: "{action} 성공: {count}개",
    batchGovernancePartial: "{success}개 성공, {failed}개 실패; 실패 항목은 선택 상태로 유지됩니다",
    statusCompleted: "완료",
    statusProcessing: "처리 중",
    statusPending: "대기 중",
    statusPendingReview: "승인 대기 중",
    statusFailed: "실패",
    statusRejected: "거부됨",
    statusDraft: "초안",
    governanceSubmit: "제출",
    governanceWithdraw: "철회",
    governanceApprove: "승인",
    governanceReject: "반려",
    governanceDelete: "삭제",
    rowEdit: "편집",
    rowRebuild: "재구축",
    rowMove: "폴더로 이동",
    rowMoveToDirectory: "폴더로 이동",
    rowMoveToCategory: "분류로 이동",
    governanceSubmitSuccess: "승인 요청을 제출했습니다",
    governanceWithdrawSuccess: "제출을 철회했습니다",
    governanceApproveSuccess: "제출을 승인했습니다",
    governanceRejectSuccess: "제출을 반려했습니다",
    governanceVersionMissing: "처리할 버전을 찾을 수 없습니다. 새로고침 후 다시 시도하세요.",
    governanceActionFailed: "작업에 실패했습니다",
    ...
    pdfDocFormat: "pdf, doc 형식 파일 지원",
    textMarkdownFormat: "text, markdown 형식 파일 지원",
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Cloud Service',
      description: 'Cloud Service APPID 및 APPSECRET 자격 증명을 설정합니다. 자격 증명은 모델 서비스와 문서 파싱 엔진에 사용됩니다.',
      viewDocs: '문서 보기',
      unconfigured: '자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 입력하세요.',
      configured: '자격 증명이 설정되었으며 정상 작동 중입니다.',
      expired: 'Cloud Service 자격 증명 만료',
      expiredDefault: '서비스 재시작 후 암호화 키가 변경되어 저장된 자격 증명을 복호화할 수 없습니다. 다시 입력하세요.',
      reconfigure: '재설정',
      appIdLabel: 'APPID',
      appIdDesc: 'Cloud Service 애플리케이션 ID',
      appIdPlaceholder: 'APPID 입력',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Cloud Service 애플리케이션 비밀키',
      appSecretPlaceholder: 'APPSECRET 입력',
      saveHint: '저장 전 서비스 연결 가능 여부를 확인하고 암호화하여 저장합니다.',
      saveBtn: '자격 증명 저장',
      usageTitle: '사용 가이드',
      usageSteps: '1. 이 페이지에서 APPID와 APPSECRET을 입력하고 저장\n2. 모델 서비스: 모델 관리에서 Remote API 소스로 모델 추가, 공급자로 CloudService 선택\n3. 문서 파싱: 지식 베이스 설정 → 파싱 엔진에서 해당 파일 유형에 Cloud Service 엔진 선택',
      fillRequired: 'APPID와 APPSECRET을 입력하세요',
      saveSuccess: '자격 증명 저장 완료',
      saveFailed: '자격 증명 저장 실패',
      credentialConfigured: 'CloudService 자격 증명이 설정되었습니다.',
      credentialExpired: '자격 증명이 만료되었습니다. 재설정하세요.',
      credentialUnconfigured: 'CloudService 자격 증명이 설정되지 않았습니다. APPID와 APPSECRET을 먼저 설정하세요.',
      checkingStatus: '자격 증명 상태 확인 중...',
      goToSettings: '설정으로 이동',
      modelHintConfigured: 'CloudService 자격 증명이 설정되었습니다. 지원 모델은',
  ...
  retrievalSettings: {
    navLabel: "검색 전략",
    title: "검색 전략",
    description: "대화, 에이전트 및 통합에서 공유하는 플랫폼 검색 예산을 설정합니다",
    queryExpansionLabel: "쿼리 확장",
    queryExpansionDescription: "필요할 때 라우팅이 쿼리를 확장하도록 허용합니다. 끄면 모든 진입점에서 확장이 비활성화됩니다",
    embeddingTopKLabel: "융합 후보 수",
    embeddingTopKDescription: "벡터와 키워드 결과를 합친 후 유지할 후보 수",
    vectorRecallTopKLabel: "벡터 사전 검색 수",
    vectorRecallTopKDescription: "융합 전 최대 벡터 검색 결과 수",
    keywordRecallTopKLabel: "키워드 사전 검색 수",
    keywordRecallTopKDescription: "융합 전 최대 키워드 검색 결과 수",
    rrfVectorWeightLabel: "RRF 벡터 가중치",
    rrfVectorWeightDescription: "융합 시 벡터와 키워드 결과의 가중치 비율",
    ...
    rerankCandidateTopKLabel: "Rerank 후보 수",
    rerankCandidateTopKDescription: "Rerank 모델에 전달할 후보 수",
    rerankTopKDescription: "재정렬 후 유지되는 최대 결과 수",
    rerankThresholdLabel: "Rerank 임계값",
    rerankThresholdDescription: "재정렬의 최소 점수 임계값 (-10 ~ 10)",
    batchProtectionTitle: "Integration 배치 검색 보호",
    batchProtectionDescription: "배치 검색의 쿼리별 유지 수와 전체 응답 크기를 제한합니다",
    batchRerankTopKLabel: "배치 쿼리별 Rerank Top K",
    batchRerankTopKDescription: "search-batch의 각 쿼리에서 재정렬 후 반환할 최대 결과 수",
    batchMaxResultsLabel: "배치 검색 전체 결과 제한",
    batchMaxResultsDescription: "search-batch 요청 하나가 반환하는 중복 제거 결과의 최대 수",
    batchMaxContentCharsLabel: "배치 검색 본문 문자 제한",
    batchMaxContentCharsDescription: "모든 search-batch 결과 본문의 최대 Unicode 문자 수",
    ...
    fallbackTitle: "답변 폴백",
    fallbackDescription: "유효한 검색 근거가 없을 때 빠른 답변에만 사용됩니다",
    fallbackStrategyLabel: "폴백 전략",
    fallbackStrategyDescription: "고정 응답을 반환하거나 모델이 프롬프트로 계속 생성하도록 합니다",
    fallbackFixed: "고정 응답",
    fallbackModel: "모델 사용",
    fallbackResponseLabel: "폴백 응답",
    fallbackResponseDescription: "유효한 검색 결과가 없을 때 반환할 고정 내용",
    fallbackResponsePlaceholder: "고정 폴백 응답을 입력하세요",
    fallbackPromptLabel: "폴백 프롬프트",
    fallbackPromptDescription: "모델 답변을 안내하며 query 및 language 자리표시자를 지원합니다",
    fallbackPromptPlaceholder: "폴백 프롬프트를 입력하세요",
    toasts: {
      saveSuccess: "검색 설정이 저장되었습니다",
      fallbackSaveSuccess: "답변 폴백 설정이 저장되었습니다",
      saveFailed: "설정 저장 실패: {message}",
    },
  },
  graphSettings: {
  ...
  initialization: {
    title: "초기화",
    welcome: "지식 질의응답 에이전트에 오신 것을 환영합니다",
  ...
  agent: {
    ...
    argumentsLabel: "파라미터",
    toolFallback: "도구",
    stepsCompleted: "{steps}개 단계 완료",
    stepsCompletedWithDuration: "{steps}개 단계 완료, 소요 시간 {duration}",
    title: "에이전트",
    ...
    editor: {
      ...
      responseStrategy: "응답 전략",
      embeddingTopK: "융합 후보 수",
      vectorRecallTopK: "벡터 사전 검색 수",
      keywordRecallTopK: "키워드 사전 검색 수",
      rrfVectorWeight: "RRF 가중치 (벡터 / 키워드)",
      keywordThreshold: "키워드 기준점",
      vectorThreshold: "벡터 임계값",
      rerankTopK: "재배치 횟수",
      rerankCandidateTopK: "재순위 후보 수",
  ...
  agentEditor: {
    ...
    desc: {
      ...
      responseStrategy: '검색 결과가 없을 때의 응답 방식을 설정합니다',
      queryExpansion: '쿼리 용어를 자동으로 확장하여 재현율 향상',
      embeddingTopK: '벡터와 키워드 융합 후 유지되는 최대 후보 수',
      vectorRecallTopK: '융합 전 벡터 검색의 최대 결과 수',
      keywordRecallTopK: '융합 전 키워드 검색의 최대 결과 수',
      rrfVectorWeight: 'RRF의 벡터 및 키워드 가중치이며 합계는 1로 고정됩니다',
      keywordThreshold: '키워드 검색의 최소 관련성 점수',
      vectorThreshold: '벡터 검색의 최소 유사도 점수',
      rerankTopK: '재순위 후 유지되는 최대 결과 수',
      rerankCandidateTopK: '재순위 모델로 전송되는 최대 융합 후보 수',
