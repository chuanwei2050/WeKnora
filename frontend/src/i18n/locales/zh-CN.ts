export default {
  ...
  knowledgeGraphExplore: {
    ...
    panorama: "全景图谱",
    collapseMenu: "收起菜单",
    searchPlaceholder: "输入关键词检索实体或文档…",
    typePlaceholder: "节点类型",
    typeDocument: "文档",
    dateFrom: "开始日期",
    dateTo: "结束日期",
    reset: "重置",
    ...
    refresh: "刷新",
    export: "导出图谱",
    exportJson: "导出 JSON（节点与边）",
    exportCsv: "导出 CSV（节点与边）",
    exportPng: "导出 PNG 图片",
    exportJsonSuccess: "已导出图谱 JSON",
    exportCsvSuccess: "已导出图谱 CSV",
    loadFailed: "加载知识图谱失败",
    empty: "暂无图谱数据。请先完成抽取；若开启审核，请先通过三元组审核。",
    emptyPie: "暂无",
    statsTitle: "图谱数据统计",
    statsKnowledge: "文档 {n}",
    statsEntity: "实体 {n}",
    statsEdge: "关系 {n}",
    statsKnowledgeLabel: "文档节点",
    statsEntityLabel: "知识点",
    statsEdgeLabel: "实体关系",
    statsRelatedLabel: "实体关系",
    statsMentionLabel: "文档提及",
    statsTagLabel: "当前标签",
    statsCanvasEdges: "画布边数",
    truncated: "已截断（全景约 300 实体），可用检索缩小范围",
    resultLimited: "已截断（全景约 300 实体），可用检索缩小范围",
    legendKnowledge: "文档",
    legendEntity: "知识点",
    legendPerson: "人物",
    legendOrg: "组织",
    ...
    legendRelated: "关联",
    legendAnnotation: "标注",
    canvasHint: "可拖拽节点，滚轮缩放；点击节点查看详情",
    typeDistTitle: "知识点类型分布",
    selectedTitle: "当前节点",
    topEntities: "热门知识点 TOP5",
    zoomIn: "放大",
    zoomOut: "缩小",
    fullscreen: "全屏",
    exitFullscreen: "退出全屏",
  ...
  knowledgeBase: {
    ...
    allDocumentsFolder: "全部文档",
    folderTitle: "文件夹",
    publicFilesFolder: "公共知识",
    publicFolderCreateAction: "新建公共文件夹",
    childFolderCreateAction: "新建子文件夹",
    folderExpandAction: "展开子文件夹",
    folderCollapseAction: "折叠子文件夹",
    folderCreateAction: "新建文件夹",
    folderSearchPlaceholder: "搜索文件夹",
    folderRenameAction: "重命名",
    folderSearchLabel: "搜索",
    folderSearchDisabledByParent: "父文件夹已关闭搜索，当前设置暂不生效",
    ...
    folderOrderIncomplete: "文件夹数量过多，当前无法拖拽排序",
    moveToFolder: "移动到文件夹",
    adjustKnowledgeCategory: "移至分类",
    batchMoveFolderSuccess: "已将 {count} 个文档移动到“{name}”",
    batchMoveFolderFailed: "批量移动失败",
    tagLabel: "分类",
    ...
    existingFileLocation: "已有文档位置：{location}",
    ...
    documentDirectoryRoot: "根目录",
    newDocumentDirectory: "新建文件夹",
    renameDocumentDirectory: "重命名",
    deleteDocumentDirectory: "删除",
    documentCount: "{count} 个文档",
    moveToDocumentDirectory: "移至目录",
    downloadDocumentDirectory: "下载",
    confirmDirectoryDeleteImpact: "将删除 {directories} 个文件夹、{documents} 个文档。确认后异步执行且不可撤销。",
    directoryDeleteAccepted: "文件夹删除任务已提交",
    directoryDeleteFailed: "文件夹删除失败，请重试",
    sortName: "名称",
    sortUpdatedAt: "更新时间",
    sortSize: "大小",
    sortType: "类型",
    ...
    batchRebuild: "批量重建",
    batchStopParse: "批量停止",
    rebuildConfirmBatch: "确认重建所选 {count} 篇文档？将清理现有分块并重新解析。",
    rebuildSubmittedBatch: "已提交 {count} 篇文档重建",
    rebuildSubmittedBatchPartial: "重建已提交 {success} 篇，失败 {failed} 篇",
    stopParseConfirm: '确认停止解析文档"{fileName}"？将清理分块、向量、队列等解析产物，文档本身保留为失败状态，可稍后重新重建。',
    stopParseConfirmBatch: "确认停止所选 {count} 篇解析中文档？将清理分块、向量、队列等解析产物，文档本身保留为失败状态，可稍后重新重建。",
    stopParseSubmitted: "已停止解析",
    stopParseSubmittedBatch: "已停止 {count} 篇文档解析",
    stopParseFailed: "停止解析失败，请稍后再试",
    draft: "草稿",
    draftTip: "暂存内容，未参与检索",
    ...
    batchGovernanceSuccess: "{action}成功，共 {count} 项",
    batchGovernancePartial: "成功 {success} 项，失败 {failed} 项；失败项已保留选择",
    statusCompleted: "已完成",
    statusProcessing: "解析中",
    statusPending: "等待中",
    statusPendingReview: "待审批",
    statusFailed: "失败",
    statusRejected: "已驳回",
    statusDraft: "草稿",
    governanceSubmit: "提交",
    governanceWithdraw: "撤销",
    governanceApprove: "通过",
    governanceReject: "驳回",
    governanceRejectCommentRequired: "驳回必须填写意见",
    governanceRejectCommentPlaceholder: "请输入驳回原因",
    governanceDelete: "删除",
    rowEdit: "编辑",
    rowRebuild: "重建",
    rowMove: "移至目录",
    rowMoveToDirectory: "移至目录",
    rowMoveToCategory: "移至分类",
    governanceSubmitSuccess: "已提交审批",
    governanceWithdrawSuccess: "已撤销提交",
    governanceApproveSuccess: "已通过审批",
    governanceRejectSuccess: "已驳回投稿",
    governanceVersionMissing: "未找到待处理版本，请刷新后重试",
    governanceActionFailed: "操作失败",
    ...
    pdfDocFormat: "支持 pdf、doc、docx 等格式",
    textMarkdownFormat: "支持 txt、markdown 等格式",
  ...
  chat: {
    ...
    graphPathsShow: "查看图谱推理路径",
    graphPathsHide: "收起图谱推理路径",
  ...
  settings: {
    ...
    graphTripleReview: {
      ...
      acceptanceNav: "验收评测",
      title: "图三元组审核",
      description: "审核抽取得到的实体关系候选；通过后才会写入图库。与知识版本治理相互独立。",
      refresh: "刷新",
      loading: "正在加载三元组候选…",
      empty: "暂无图三元组审核单。",
      emptyPending: "暂无待审核的图三元组",
      emptyFiltered: "当前筛选下没有审核单",
      emptyHint: "知识库完成实体关系抽取后，候选会出现在这里。通过后才会写入图库。",
      countLabel: "{n} 条",
      relationCount: "{n} 条关系",
      entityCount: "{n} 个实体",
      knowledgeBase: "知识库",
      chunkLabel: "分块",
      noRelations: "没有可展示的关系",
      loadFailed: "图三元组列表加载失败",
      approve: "通过并入图",
      approveConfirm: "通过后将写入图库，确定继续？",
      reject: "驳回",
      rejectTitle: "驳回这条候选",
      rejectCommentLabel: "驳回原因（可选）",
      rejectCommentPlaceholder: "填写原因，方便后续排查",
      approveSuccess: "已写入图库",
      approveFailed: "通过失败（候选仍保持待审，可重试）",
      rejectSuccess: "已驳回",
      rejectFailed: "驳回失败",
      selectAll: "全选",
      batchApprove: "批量通过",
      batchReject: "批量驳回",
      batchApproveConfirm: "将通过并写入图库 {n} 条，确定继续？",
      batchRejectTitle: "批量驳回 {n} 条",
      batchApproveSuccess: "已通过 {n} 条",
      batchRejectSuccess: "已驳回 {n} 条",
      batchPartial: "成功 {ok} 条，失败 {failed} 条（失败项已恢复待审）",
      statusPending: "待审核",
      statusWritten: "已入图",
      statusRejected: "已驳回",
    ...
    weknoraCloud: {
      title: "云服务",
      description: "配置 APPID / APPSECRET，用于模型服务与文档解析。",
      viewDocs: "查看文档",
      ...
      saveBtn: "保存凭证",
      usageTitle: "使用说明",
      usageSteps: "1. 在此页面填写并保存 APPID 和 APPSECRET\n2. 模型服务：前往「模型管理」添加模型，选择 Remote API 来源，厂商选择「云服务」\n3. 文档解析：前往「知识库设置 → 解析引擎」，为对应文件类型选择「云服务」引擎",
    ...
    parser: {
      title: "解析引擎",
      description: "优先于服务端环境变量；留空则使用环境变量默认值。",
      loading: "加载中...",
      retry: "重试",
    ...
    storage: {
      title: "存储引擎",
      description: "在此配置各引擎参数；知识库中只选择使用哪个引擎。",
      loading: "加载中...",
      retry: "重试",
      defaultEngine: "默认引擎",
      ...
      approvedEndpointLabel: "批准的内网端点",
      approvedEndpointPlaceholder: "选择管理员批准的对象存储端点",
      publicEndpointOption: "公共端点（线上模式）",
      cosTitle: "腾讯云 COS",
  ...
  webSearchSettings: {
    ...
    approvedEndpointLabel: "批准的内网端点",
    approvedEndpointPlaceholder: "选择管理员批准的搜索端点",
    publicEndpointOption: "公共端点（线上模式）",
    approvedEndpointHelp: "严格离线模式必须选择已登记且用途为 query 的端点；选择后不能再使用代理。",
    apiKeyLabel: "API 密钥",
  ...
  chatHistorySettings: {
    ...
    enableLabel: "启用消息索引",
    enableDescription: "开启后新对话消息自动索引，支持向量搜索",
  ...
  retrievalSettings: {
    ...
    queryExpansionDescription: "需要时扩展查询以提高召回；关闭后所有入口均不扩展",
    ...
    keywordRecallTopKLabel: "关键词预召回数量",
    keywordRecallTopKDescription: "关键词检索进入融合阶段前的最大召回数量",
    rrfVectorWeightLabel: "RRF 向量权重",
    rrfVectorWeightDescription: "设置融合时向量结果与关键词结果的权重比例",
    ...
    rerankCandidateTopKLabel: "Rerank 候选数量",
    rerankCandidateTopKDescription: "送入 Rerank 模型进行重排序的候选数量",
    rerankTopKDescription: "重排序后保留的最大结果数量",
    rerankThresholdLabel: "Rerank 阈值",
    rerankThresholdDescription: "重排序的最低分数阈值（-10 到 10）",
    batchProtectionTitle: "Integration 批量检索保护",
    batchProtectionDescription: "单独限制批量检索每题保留数及整批响应规模",
    batchRerankTopKLabel: "批量 Rerank 每题保留数",
    batchRerankTopKDescription: "search-batch 中每个问题重排序后最多返回的结果数量",
    batchMaxResultsLabel: "批量检索总结果上限",
    batchMaxResultsDescription: "search-batch 整批最多返回的去重结果数量",
    batchMaxContentCharsLabel: "批量检索正文字符上限",
    batchMaxContentCharsDescription: "search-batch 所有结果正文合计允许的最大 Unicode 字符数",
    rerankModelLabel: "Rerank 模型",
    rerankModelDescription: "选择用于搜索结果重排序的模型",
    rerankModelRequired: "请选择 Rerank 模型，搜索功能需要此模型对结果进行重排序",
    fallbackTitle: "回答兜底",
    fallbackDescription: "仅用于快速问答在没有检索到有效证据时生成最终回复",
    fallbackStrategyLabel: "兜底策略",
    fallbackStrategyDescription: "选择直接返回固定内容，或交给模型根据提示词继续生成",
    fallbackFixed: "固定回复",
    fallbackModel: "模型生成",
    fallbackResponseLabel: "兜底回复",
    fallbackResponseDescription: "没有有效检索结果时直接返回的固定内容",
    fallbackResponsePlaceholder: "请输入固定兜底回复",
    fallbackPromptLabel: "兜底提示词",
    fallbackPromptDescription: "没有有效检索结果时用于引导模型回答，支持 query 和 language 占位符",
    fallbackPromptPlaceholder: "请输入兜底提示词",
    toasts: {
      saveSuccess: "检索配置已保存",
      fallbackSaveSuccess: "回答兜底配置已保存",
      saveFailed: "保存配置失败: {message}",
    },
  },
  graphSettings: {
    title: "知识图谱配置",
    description: "从文档抽取实体关系写入知识图谱，与 Wiki 页面图谱不同。",
    enableLabel: "启用实体关系提取",
    enableDescription: "仅对新处理或重建的文档生效。",
    rebuildLabel: "一键重建知识图谱",
    rebuildDescription: "清空现有图谱后按当前配置重新抽取，不可撤销。",
    rebuildConfirm: "确认清理并重建本知识库的知识图谱？此操作不可撤销。",
    rebuildStarted: "已入队 {n} 个文档，开始重建…",
    rebuildSuccess: "已清理图谱并入队 {n} 个文档的抽取任务",
    rebuildQueuedReview: "已清理图谱并入队 {n} 个文档。当前开启了三元组人工审核。",
    rebuildRunning: "正在重建：已完成 {done}/{total} 个抽取任务",
    rebuildAwaitingReview: "抽取已完成，有 {n} 条待审核；通过后才会写入图谱。",
    rebuildCompletedAt: "重建完成（{time}）",
    rebuildFailed: "知识图谱重建失败",
    extractModeLabel: "抽取方式",
    extractModeDescription: "通用自动抽；模板快速填充；自定义完全自定 Schema。",
    modeGeneral: "通用抽取",
    modeTemplate: "使用模板",
    modeCustom: "自定义 Schema",
    templateLabel: "配置模板",
    templateDescription: "应用后可继续编辑 Schema 与示例。",
    entitySchemaLabel: "实体类型 Schema",
    entitySchemaDescription: "约束允许抽取的实体类型及其含义。",
    relationSchemaLabel: "关系类型 Schema",
    relationSchemaDescription: "约束关系类型与起点→终点方向。",
    addEntityType: "添加实体类型",
    addRelationType: "添加关系类型",
    entityTypeNamePlaceholder: "名称",
    entityBaseTypePlaceholder: "类型",
    schemaDescriptionPlaceholder: "说明",
    advancedSettingsTitle: "高级抽取设置",
    exampleSettingsTitle: "抽取示例与测试（可选）",
    extractionModelLabel: "图谱抽取模型",
    extractionModelDescription: "未选择时回退到知识库摘要模型",
    useFallbackModel: "改用知识库摘要模型",
    ingestionModeLabel: "入图范围",
    ingestionModeDescription: "「仅关系信号」只处理含明确关系线索的文本块。",
    ingestionModeAll: "所有非空文本（推荐）",
    ingestionModeSignal: "仅关系信号文本",
    extractionLimitsLabel: "抽取质量边界",
    extractionLimitsDescription: "限制单块图规模，并过滤低置信度关系。",
    maxEntitiesLabel: "最多实体数",
    maxRelationsLabel: "最多关系数",
    minConfidenceLabel: "最低关系置信度",
    tagsLabel: "关系类型（白名单）",
    tagsDescription: "允许入库的关系类型；留空则不限制。",
    tagsPlaceholder: "输入关系类型，如：uses、tests、supports",
    entityTypesLabel: "实体类型（白名单）",
    entityTypesDescription: "允许的实体类型；严格模式下作为硬约束。",
    entityTypesPlaceholder: "输入实体类型，如：tool、metric、defect",
    strictSchemaLabel: "仅保留白名单类型",
    strictSchemaDescription: "丢弃白名单之外的实体和关系。",
    requireTripleReviewLabel: "三元组需人工审核",
    requireTripleReviewDescription: "通过后才写入图库；开启后重建也会进审核队列。",
    openTripleReview: "进入三元组审核",
    rulesLabel: "入库与搜图规则",
    rulesDescription: "入图范围由上方模式控制；问答是否搜图由系统按问题自动判断。",
    generalExtractionTemplate: "通用抽取（不限领域）",
    softwareTestingTemplate: "软件测评",
    applyTemplate: "应用模板",
    templateLoaded: "模板已应用，字段仍可继续编辑",
    defaultsHint: "模板只填充初始 Schema 与示例，不自动绑定知识库。",
    sampleTextLabel: "Few-shot 示例文本",
    sampleTextDescription: "仅给模型示范，不会直接写入图库。",
    sampleTextPlaceholder: "输入一段与知识库领域一致、包含明确实体和关系的自然语言文本...",
    generateRandomText: "根据关系类型生成测试文本",
    entityListLabel: "期望实体（Few-shot 输出）",
    entityListDescription: "示例文本的期望实体，不是已入库实体。",
    nodeNamePlaceholder: "输入实体名称",
    nodeTypePlaceholder: "选择或输入实体类型，如：tool",
    aliasesPlaceholder: "输入实体别名，可添加多个",
    attributePlaceholder: "输入属性值",
    addAttribute: "添加属性",
    manageEntitiesLabel: "管理实体",
    manageEntitiesDescription: "添加或删除实体节点",
    addEntity: "添加实体",
    relationListLabel: "期望关系（Few-shot 输出）",
    relationListDescription: "示例文本的期望关系，不是已入库关系。",
    selectEntity: "选择实体",
    selectRelationType: "选择关系类型",
    confidencePlaceholder: "置信度",
    manageRelationsLabel: "管理关系",
    manageRelationsDescription: "添加或删除实体间的关系",
    addRelation: "添加关系",
    extractActionsLabel: "试运行",
    extractActionsDescription: "只测试当前配置，不写入图数据库。",
    startExtraction: "试运行提取",
    extracting: "提取中...",
    defaultExample: "默认示例",
    clearExample: "清除示例",
    ...
    extractFailedWithReason: "实体关系提取失败：{reason}",
    extractSummary: "试运行完成：保留 {entities} 个实体、{relations} 条关系（已按白名单、上限与置信度过滤）。",
    exampleLoaded: "示例已加载",
  ...
  agent: {
    ...
    argumentsLabel: "参数",
    toolFallback: "工具",
    stepsCompleted: "已完成 {steps} 个步骤",
    stepsCompletedWithDuration: "已完成 {steps} 个步骤，耗时 {duration}",
    title: "智能体",
    subtitle: "配置和管理平台智能体，保存后对所有租户生效",
    createAgent: "创建智能体",
    createAgentShort: "新建",
    builtin: "内置",
    disabled: "已停用",
    ...
    shareScope: {
      title: "共享范围说明",
      desc: "成员只读使用，能力与资源跟随当前配置，修改会同步到已共享空间。若需编辑知识库内容，请单独共享知识库。",
      knowledgeBase: "知识库",
      chatModel: "对话模型",
      rerankModel: "重排模型",
      webSearch: "网络搜索",
  ...
  file: {
    ...
    deleteFailed: "文件删除失败",
    download: "下载文件",
    downloading: "正在写入文件 {progress}%（完成前请勿打开）",
    downloadSuccess: "文件下载完成",
  ...
  tenant: {
    ...
    api: {
      ...
      keyLabel: "API Key",
      keyDescription: "请妥善保管，勿泄露",
      urlLabel: "API 地址",
      urlDescription: "REST API 基础路径，请求时拼接具体接口",
  ...
  error: {
    ...
    requestTimeout: "请求超时，知识库较大时预览可能较慢，请稍后重试",
  ...
  model: {
    ...
    editor: {
      ...
      validatingVision: "正在验证视觉能力，请稍候…",
      visionValidationSuccess: "视觉能力验证成功",
      thinkingLabel: "深度思考",
      thinkingDesc: "调用该模型时默认启用扩展思考能力（需要模型支持）",
      validatingThinking: "正在验证深度思考能力，请稍候…",
      thinkingValidationSuccess: "深度思考能力验证成功",
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      granularityStandardHint: "抽取主角与被详细描述的次要实体；跳过一带而过的通用词。",
      granularityExhaustiveHint: "抽取所有可识别实体与概念（含一带而过的技术栈），适合当术语表用。",
    },
    indexing: {
      title: "索引策略",
      description: "可独立开关各索引方式",
      searchTitle: "RAG 检索",
      searchDesc: "分块、向量化与关键词索引，支持混合检索",
      wikiTitle: "Wiki 知识库",
      wikiDesc: "自动生成互相关联的 Wiki 页面",
      graphTitle: "知识图谱",
      graphDesc: "抽取实体关系，支持图谱检索",
    ...
    reprocess: {
      ...
      confirmBody: "该操作会清理现有分块及其派生数据，重新解析已完成或解析失败的文档，并重建摘要、块问题、ES、向量索引及已启用的知识图谱。正在等待或处理中的文档不会重复入队。处理期间检索结果可能暂时不完整，是否继续？",
    ...
    maintenance: {
      ...
      stop: "停止重建",
      stopSubmitted: "已停止重建：在途文档已中断，维护操作已解锁",
      stopFailed: "停止重建失败",
      stopAllParses: "全部停止解析",
      stopAllParsesConfirm: "确认停止当前 {count} 篇解析中文档？将清理分块、向量、队列等解析产物，文档本身保留为失败状态，可稍后重新重建。",
      stopAllParsesSubmitted: "已停止 {count} 篇文档解析",
      stopAllParsesFailed: "全部停止解析失败",
      statusLoadFailed: "无法加载重建进度",
      statusLoadFailedHint: "后端繁忙或请求超时。后台任务可能仍在运行，请稍后重试，避免重复提交。",
      retryStatus: "重新加载",
      canceling: "正在停止重建：已完成 {processed}/{total}。",
      forceUnlock: "强制解锁",
      canceled: "重建已停止：在途文档已中断，已完成的结果会保留，维护操作已解锁。",
      completed: "{name}已完成",
      completedWithFailures: "任务完成，其中 {failed} 篇失败，请查看服务日志。",
      submitted: "{name}任务已提交",
      submitFailed: "提交维护任务失败",
      confirm: "确认执行“{name}”？运行期间将禁止其他重建操作。",
      graphDisabled: "请先启用知识图谱",
      keywordDisabled: "请先启用关键词检索",
      vectorDisabled: "请先启用向量检索",
      questionsDisabled: "请先在高级设置中启用块问题生成",
      structuredDisabled: "结构化查询服务未启用",
      actions: {
        reparse: { label: "全部重建", description: "一键跑完整流程：重新解析全部文档和分块，并重建摘要、块问题、关键词/ES、向量、结构化数据及已启用的知识图谱。可用「全部停止解析」中断当前解析中文档。" },
    ...
    faq: {
      ...
      questionIndexModeDescription: "合并：标准问与相似问一起索引；分别：各自独立索引，更准但占更多存储。",
      entryGuide: "条目含标准问、相似问、反例与多个答案，可在详情中批量导入与编辑。",
      tagDesc: "为条目选择分类",
      tagPlaceholder: "请选择分类",
      modes: {
      ...
      standardQuestionDesc: "问题的标准表述",
      answers: "答案",
      answersDesc: "可添加多个答案",
      similarQuestions: "相似问",
      similarQuestionsDesc: "意思相同、表述不同的问法，提高匹配",
      negativeQuestions: "反例",
      negativeQuestionsDesc: "不应匹配此答案的问题，用于排除误匹配",
    ...
    chunking: {
      ...
      parentChildDescription: "父块提供上下文，子块用于向量匹配。",
      inheritHeadingLabel: "继承章节标题",
      inheritHeadingDescription: "将 Markdown 章节标题写入后续块正文，提升命中。仅对新导入/重建生效。",
    ...
    asr: {
      title: "音频语音识别",
      description: "启用后可上传音频并整段转写为文本（mp3/wav/m4a 等）。暂不支持视频。",
      label: "启用音频语音识别",
      desc: "上传音频后自动转写并参与检索",
      modelLabel: "ASR 模型",
      modelDescription: "语音转文本模型（如 Whisper）",
    ...
    advanced: {
      ...
      questionGeneration: {
        label: "AI 问题生成",
        description: "为每个分块生成相关问题以提高召回；会增加解析耗时。",
        countLabel: "生成问题数量",
        countDescription: "每个分块生成的问题数（1-10）",
      },
      multimodal: {
        label: "多模态功能",
        description: "启用图片等内容理解",
        vllmLabel: "VLLM 视觉模型",
  ...
  agentSettings: {
    ...
    modelRecommendation: {
      title: "模型推荐",
      content: "建议使用支持 Function Calling 的长上下文模型，如 deepseek-v3.1-terminus",
    },
    status: {
      label: "Agent 状态",
      ready: "可用",
      notReady: "未就绪",
      hint: '配置完成后状态变为「可用」，即可在对话中开启 Agent 模式',
    ...
    globalConfigNotice: "全局默认配置，新建智能体会继承；也可在智能体中单独覆盖。",
  ...
  modelSettings: {
    ...
    modelProfile: {
      title: "模型 Profile 检查清单",
      profileLabel: "当前 PROFILE",
      airGappedOn: "严格离线已开启",
      airGappedOff: "严格离线未开启",
      invalidProfile: "PROFILE 无效，已按 online 对照",
      summary: "缺口：缺 env {missingEnv} · 未登记 {missingReg} · 不匹配 {mismatch} · 通过 {ok}",
      disclaimer: "改 MODEL_PROFILE 不会自动切换线上流量；需在此登记/重绑模型。期望名须与登记 name 一致（model-scripts 请用 served_model_name）。",
      expand: "展开角色清单",
      collapse: "收起角色清单",
      expected: "期望",
      statusOk: "通过",
      statusMissingEnv: "缺 env",
      statusMissingReg: "未登记",
      statusMismatch: "不匹配",
      actionAdd: "添加",
      actionEdit: "编辑",
      fillEnvFirst: "请先补齐 .env",
      loadFailed: "加载 profile 状态失败",
      builtinCannotEdit: "匹配到内置模型，无法在清单中直接编辑；请改用租户自有模型或调整 env 期望名",
    },
    actions: {
      addModel: "添加模型",
      setDefault: "设为默认",
  ...
  organization: {
    ...
    settings: {
      ...
      sharedAgentsKbHint: "智能体绑定知识库仅对话内只读，不会出现在知识库列表；需在列表看到或编辑请单独共享。",
      ...
      permissionCalcTip: "实际权限 = min(空间权限, 我在本空间的角色)。",
      inviteMembers: "邀请成员",
  ...
  preview: {
    ...
    fullPreview: "完整预览",
    originalPartialPreviewHint: "当前仅展示原文前 30 页；请点击文件名右侧的下载按钮查看完整内容。",
    partialPreviewGenerating: "正在后台生成前 30 页原文预览…",
    partialPreviewFailed: "部分预览生成失败",
  },
  knowledgeSearch: {
    title: "搜索",
  ...
  kbSettings: {
    storage: {
      title: "存储引擎",
      description: "选择存储引擎；参数在全局设置中配置。",
      loading: "加载中...",
      engineLabel: "存储引擎",
      engineDesc: "需在全局设置中已配置对应引擎。",
    ...
    parser: {
      title: "解析引擎",
      description: "按文件类型选择解析引擎；未配置的类型使用内置引擎。",
      loading: "加载中...",
  ...
  agentEditor: {
    ...
    desc: {
      ...
      responseStrategy: "配置无匹配内容时的回答方式",
      queryExpansion: "自动扩展查询词以提高召回率",
      embeddingTopK: "向量与关键词融合后保留的最大候选数量",
      vectorRecallTopK: "向量通道参与融合前最多召回的结果数量",
      keywordRecallTopK: "关键词通道参与融合前最多召回的结果数量",
      rrfVectorWeight: "设置向量与关键词在 RRF 融合中的权重，两者之和固定为 1",
      keywordThreshold: "关键词检索的最低相关性分数",
      vectorThreshold: "向量检索的最低相似度分数",
      rerankTopK: "重排序后保留的最大结果数量",
      rerankCandidateTopK: "融合结果中送入重排模型的最大候选数量",
    ...
    im: {
      ...
      description: "接入企业微信、飞书、Slack、钉钉等即时通讯平台",
      wecom: "企业微信",
      feishu: "飞书",
      slack: "Slack",
      telegram: "Telegram",
  ...
  feishuPublish: {
    title: "同步飞书",
    description: "将本知识库手动发布到飞书 Wiki（无定时）。冲突时以本知识库为准覆盖飞书侧托管内容。",
    viewGuide: "查看教程",
    guideTitle: "飞书同步配置教程",
    guideIntro: "按页面逐步配置。蓝色按钮可跳转到对应飞书页面。",
    guide: {
      step1Title: "1. 创建企业自建应用",
      step1Where: "页面：飞书开放平台 → 开发者后台",
      step1Body: "点击「创建企业自建应用」（不要选商店应用或智能体）。进入应用后打开「凭证与基础信息」，复制 App ID（cli_ 开头）和 App Secret（点眼睛查看明文）。",
      step1Link: "打开开发者后台",
      step2Title: "2. 开通权限",
      step2Where: "页面：应用详情 → 权限管理 → 开通权限（应用身份）",
      step2Body: "至少勾选：wiki:wiki、wiki:node:create、docx:document、drive:file、docs:document.media:upload。开通后不会立刻生效，必须发布版本。",
      step2Link: "权限说明文档",
      step3Title: "3. 发布应用",
      step3Where: "页面：应用详情 → 版本管理与发布",
      step3Body: "点击「创建版本」→ 填写版本号与说明 → 保存 →「确认发布」。顶部应用状态变为「已启用」后权限才对线上生效。",
      step4Title: "4. 开通机器人能力（便于搜到应用）",
      step4Where: "页面：应用详情 → 添加应用能力 → 机器人",
      step4Body: "开通「机器人」后再次「创建版本并发布」。未开通时，知识空间成员搜索框通常搜不到应用名。",
      step5Title: "5. 把应用加入目标知识空间",
      step5Where: "页面：飞书 → 目标知识库/知识空间 → 设置 → 成员设置",
      step5Body: "选择「添加管理员」或可编辑成员，搜索应用名称并添加。若仍搜不到：先建群并把应用加为群机器人，再在成员设置中搜索该群并添加。",
      step5Link: "打开飞书云文档",
      step6Title: "6. 在本页配置并同步",
      step6Where: "页面：本知识库 → 设置 → 同步飞书（当前页）",
      step6Body: "填写 App ID / App Secret（会自动加载知识空间）→ 选择目标空间与同步位置 →「预览并同步」确认入队。绑定后可点「立即同步」；运行中可看进度条。失败可在明细里「重试失败项」。同步完成后可在飞书中查看结果。",
      step6Link: "打开飞书",
      treeTitle: "同步成功后飞书侧目录",
      treeBody: "<知识库名称>\n├── 公共知识 → 标签 → 右侧目录 → 文档\n├── 未分类\n├── 其它非公共一级标签\n└── _已归档（本知识库删除的文档会移入）",
      openConsole: "开发者后台",
    },
    featureDisabled: "飞书知识同步功能未启用，请联系管理员。",
    appId: "App ID",
    appIdPlaceholder: "cli_xxxx",
    appIdRequired: "请填写 App ID",
    appSecret: "App Secret",
    appSecretPlaceholder: "请输入 App Secret",
    appSecretTip: "已保存的密钥不会回显；留空表示沿用已配置密钥。修改 App ID 后须重新填写。",
    appSecretRequired: "请填写 App Secret",
    appSecretRequiredOnAppIdChange: "修改 App ID 后须重新填写 App Secret",
    secretConfigured: "已配置",
    discoverSpaces: "获取知识空间",
    discovering: "正在加载知识空间…",
    retryDiscover: "重试",
    discoverSuccess: "已获取可访问的知识空间",
    noSpaces: "当前应用没有可访问的知识空间",
    permissionHint: "请确认已开通 Wiki 相关权限，并将应用通过群聊添加为知识空间成员。",
    space: "目标知识空间",
    spacePlaceholder: "请选择知识空间",
    spaceLoading: "正在加载知识空间…",
    spaceFailedHint: "加载失败，请重试",
    spaceDisabledHint: "填写凭据后自动加载",
    spaceRequired: "请选择目标知识空间",
    spaceLockedHint: "知识空间已锁定。如需切换到其他空间，请先解除绑定。",
    location: "同步位置",
    locationTip: "选择托管首页所在的父页面；默认为知识空间根目录。",
    spaceRoot: "知识空间根目录",
    syncNow: "立即同步",
    editConfig: "更改配置",
    editingConfigHint: "正在更改飞书同步配置",
    previewSync: "预览并同步",
    retryFailures: "重试失败项",
    retryFailuresHint: "再次同步会跳过已成功项，仅补齐失败、冲突与阻塞项。单文件超过上传上限的项会改为跳过，请压缩后重新上传再同步。",
    errors: {
      fileTooLarge: "文件超过单文件上传上限（当前 2GB）。重试无效，请压缩或拆分后重新上传。详情：{detail}",
    },
    previewTitle: "同步影响预览",
    previewIntro: "确认后将保存配置并开始异步同步。",
    previewNoChanges: "无需要执行的变更",
    previewWarnings: "注意事项：",
    confirmSync: "确认同步",
    syncQueued: "同步任务已提交",
    impactChanged: "同步影响已变化，请重新确认",
    activeRunWarning: "当前有进行中的同步任务，请稍后再试",
    unbind: "解除绑定",
    unbindConfirm: "解除绑定将清除本知识库的飞书发布配置与密钥，不会删除飞书侧已有页面。",
    unbindSecondTitle: "再次确认解除绑定",
    unbindSecondBody: "飞书知识库中的页面不会被删除，之后也不会再自动维护。确定继续？",
    unbindConfirmBtn: "确认解除",
    unbindSuccess: "已解除绑定",
    ...
    viewFailures: "查看失败项",
    failuresTitle: "失败 / 冲突明细",
    openInFeishu: "在飞书中打开",
    spaceMoveTitle: "确认更换同步位置",
    spaceMoveBody: "知识空间已锁定。更换同步位置将移动整个托管首页到新位置，是否继续？",
    spaceMoveConfirm: "确认更换",
    discardTitle: "放弃未保存更改？",
    discardBody: "同步飞书页签中有未提交的更改，切换或关闭将丢失这些更改。",
    discardConfirm: "放弃更改",
  },
};
