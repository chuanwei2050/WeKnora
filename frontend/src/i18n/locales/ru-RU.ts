export default {
  ...
  knowledgeBase: {
    ...
    allDocumentsFolder: 'Все документы',
    folderTitle: 'Папки',
    publicFilesFolder: 'Общие знания',
    publicFolderCreateAction: 'Новая общая папка',
    childFolderCreateAction: 'Новая подпапка',
    folderExpandAction: 'Развернуть подпапки',
    folderCollapseAction: 'Свернуть подпапки',
    folderCreateAction: 'Новая папка',
    folderSearchPlaceholder: 'Поиск папок',
    folderRenameAction: 'Переименовать',
    folderSearchLabel: 'Поиск',
    folderSearchDisabledByParent: 'Поиск отключён в родительской папке, поэтому эта настройка сейчас не действует',
    ...
    folderOrderIncomplete: 'Слишком много папок для сортировки',
    moveToFolder: 'Переместить в папку',
    adjustKnowledgeCategory: 'В категорию',
    batchMoveFolderSuccess: 'Документы ({count}) перемещены в «{name}»',
    batchMoveFolderFailed: 'Не удалось переместить документы',
    tagLabel: 'Категория',
    ...
    existingFileLocation: 'Расположение документа: {location}',
    ...
    batchGovernanceSuccess: '{action}: успешно обработано {count}',
    batchGovernancePartial: 'Успешно: {success}, с ошибкой: {failed}; ошибочные элементы остались выбранными',
    statusCompleted: 'Завершено',
    statusProcessing: 'Обработка',
    statusPending: 'Ожидание',
    statusPendingReview: 'Ожидает одобрения',
    statusFailed: 'Ошибка',
    statusRejected: 'Отклонено',
    statusDraft: 'Черновик',
    governanceSubmit: 'Отправить',
    governanceWithdraw: 'Отозвать',
    governanceApprove: 'Одобрить',
    governanceReject: 'Отклонить',
    governanceDelete: 'Удалить',
    rowEdit: 'Править',
    rowRebuild: 'Пересобрать',
    rowMove: 'В папку',
    rowMoveToDirectory: 'В папку',
    rowMoveToCategory: 'В категорию',
    governanceSubmitSuccess: 'Отправлено на проверку',
    governanceWithdrawSuccess: 'Заявка отозвана',
    governanceApproveSuccess: 'Заявка одобрена',
    governanceRejectSuccess: 'Заявка отклонена',
    governanceVersionMissing: 'Ожидающая версия не найдена. Обновите страницу и повторите попытку.',
    governanceActionFailed: 'Не удалось выполнить действие',
    ...
    pdfDocFormat: 'Поддерживаются pdf, doc, docx и др.',
    textMarkdownFormat: 'Поддерживаются txt, markdown и др.',
  ...
  agent: {
    ...
    editor: {
      ...
      responseStrategy: 'Стратегия ответа',
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'Cloud Service',
      description: 'Настройте учётные данные APPID и APPSECRET для Cloud Service. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Cloud Service истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Cloud Service',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Cloud Service',
      ...
      usageSteps: '1. Заполните и сохраните APPID и APPSECRET\n2. Модели: перейдите в управление моделями, добавьте модель с источником Remote API, выберите CloudService\n3. Парсинг документов: перейдите в настройки базы знаний → движок парсинга, выберите Cloud Service для нужных типов файлов',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные CloudService настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные CloudService не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные CloudService настроены. Поддерживаемые модели см. в',
...
/example\.(net|org)/`,
  ...
  retrievalSettings: {
    navLabel: 'Стратегия поиска',
    title: 'Стратегия поиска',
    description: 'Настройте платформенный бюджет поиска для чатов, агентов и интеграций',
    queryExpansionLabel: 'Расширение запроса',
    queryExpansionDescription: 'Разрешить маршрутизации расширять запросы при необходимости; отключение запрещает расширение во всех точках входа',
    embeddingTopKLabel: 'Количество кандидатов после объединения',
    embeddingTopKDescription: 'Количество кандидатов после объединения векторных результатов и ключевых слов',
    vectorRecallTopKLabel: 'Количество векторных результатов',
    vectorRecallTopKDescription: 'Максимальное число векторных результатов до объединения',
    keywordRecallTopKLabel: 'Количество результатов по ключевым словам',
    keywordRecallTopKDescription: 'Максимальное число результатов по ключевым словам до объединения',
    rrfVectorWeightLabel: 'Вес вектора RRF',
    rrfVectorWeightDescription: 'Соотношение весов векторных результатов и ключевых слов при объединении',
    ...
    rerankCandidateTopKLabel: 'Количество кандидатов Rerank',
    rerankCandidateTopKDescription: 'Количество кандидатов, передаваемых модели Rerank',
    ...
    batchProtectionTitle: 'Защита пакетного поиска Integration',
    batchProtectionDescription: 'Настройка лимита на запрос и общего размера пакетного ответа',
    batchRerankTopKLabel: 'Batch Rerank Top K на запрос',
    batchRerankTopKDescription: 'Максимум результатов после переранжирования для каждого запроса search-batch',
    batchMaxResultsLabel: 'Общий лимит результатов пакета',
    batchMaxResultsDescription: 'Максимальное число уникальных результатов одного запроса search-batch',
    batchMaxContentCharsLabel: 'Лимит символов содержимого пакета',
    batchMaxContentCharsDescription: 'Максимальное суммарное число Unicode-символов в содержимом результатов search-batch',
    ...
    fallbackTitle: 'Резервный ответ',
    fallbackDescription: 'Используется только быстрыми ответами при отсутствии достоверных результатов поиска',
    fallbackStrategyLabel: 'Стратегия резервного ответа',
    fallbackStrategyDescription: 'Вернуть фиксированный текст или продолжить генерацию с помощью модели',
    fallbackFixed: 'Фиксированный ответ',
    fallbackModel: 'Использовать модель',
    fallbackResponseLabel: 'Резервный ответ',
    fallbackResponseDescription: 'Фиксированный текст при отсутствии достоверных результатов поиска',
    fallbackResponsePlaceholder: 'Введите фиксированный резервный ответ',
    fallbackPromptLabel: 'Резервная подсказка',
    fallbackPromptDescription: 'Подсказка для модели; поддерживает заполнители query и language',
    fallbackPromptPlaceholder: 'Введите резервную подсказку',
    toasts: {
      saveSuccess: 'Конфигурация поиска сохранена',
      fallbackSaveSuccess: 'Настройки резервного ответа сохранены',
      saveFailed: 'Не удалось сохранить конфигурацию: {message}',
    },
  },
  graphSettings: {
    ...
    templateLabel: 'Шаблон конфигурации',
    templateDescription: 'Заполните правила шаблоном и при необходимости уточните их в расширенных настройках.',
    generalExtractionTemplate: 'Общее извлечение (любая область)',
    softwareTestingTemplate: 'Тестирование ПО',
    advancedSettingsTitle: 'Расширенные настройки извлечения',
    exampleSettingsTitle: 'Примеры и тестирование извлечения (необязательно)',
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в агент вопросов и ответов',
  ...
  model: {
    ...
    editor: {
      ...
      validatingVision: 'Проверка поддержки изображений…',
      visionValidationSuccess: 'Поддержка изображений успешно проверена',
      thinkingLabel: 'Глубокое мышление',
      thinkingDesc: 'По умолчанию включать расширенное мышление при вызове этой модели (требуется поддержка модели)',
      validatingThinking: 'Проверка глубокого мышления…',
      thinkingValidationSuccess: 'Глубокое мышление успешно проверено',
  ...
  preview: {
    ...
    excelTruncated: 'Таблица слишком большая. Для сохранения отзывчивости показана только часть данных; скачайте файл для полного просмотра.',
    textTruncated: 'Текстовый файл слишком большой. Для сохранения отзывчивости показана только часть содержимого; скачайте файл для полного просмотра.',
    largeFileBlocked: 'Полный онлайн-просмотр пропущен из-за большого размера документа',
    largeFileHint: 'Чтобы страница оставалась отзывчивой, просмотрите извлечённые фрагменты или скачайте исходный файл.',
  },
  knowledgeSearch: {
    title: 'Поиск',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Cloud Service',
          desc: 'Парсинг документов через Cloud Service',
        },
      },
    },
    supportedFormats: 'Поддерживаемые форматы'
  ...
  agentEditor: {
    agui: {
      label: 'Показывать процесс AG-UI',
      desc: 'Показывать рассуждения, вызовы инструментов и потоковый вывод в чате и виджете',
    },
    ...
    desc: {
      ...
      responseStrategy: 'Настройте ответ при отсутствии совпадений',
      queryExpansion: 'Автоматическое расширение поисковых запросов для улучшения полноты',
      embeddingTopK: 'Максимальное количество кандидатов после объединения векторного и ключевого поиска',
      vectorRecallTopK: 'Максимальное количество векторных результатов до объединения',
      keywordRecallTopK: 'Максимальное количество результатов по ключевым словам до объединения',
      rrfVectorWeight: 'Веса векторного поиска и поиска по ключевым словам в RRF; их сумма равна 1',
      ...
      rerankCandidateTopK: 'Максимальное количество объединённых кандидатов для модели переранжирования',
    ...
    attachmentUpload: {
      label: 'Загрузка вложений',
      desc: 'Позволяет пользователям загружать вложения (документы, аудио и т.д.) в чате',
    },
    faq: {
