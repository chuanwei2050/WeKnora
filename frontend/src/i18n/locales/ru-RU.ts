...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      codeLabel: 'Код базы знаний',
      codePlaceholder: 'Для фильтрации баз знаний (необязательно)',
    ...
    messages: {
      ...
      codeInvalid: 'Допустимы только буквы, цифры, дефис и подчёркивание (до 64 символов)',
