...
type OCRRequest struct {
	...
	// backend selects OCR engine; empty/default = paddle.
...
func (x *OCRRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *OCRRequest) GetBackend() string {
	if x != nil {
		return x.Backend
	}
	return ""
...
func (x *OCRResponse) GetBackend() string {
	if x != nil {
		return x.Backend
	}
	return ""
...
const file_docreader_proto_rawDesc = "" +
	...
	"\aengines\x18\x01 \x03(\v2\x1b.docreader.ParserEngineInfoR\aengines\"\x81\x01\n" +
	"\n" +
	"OCRRequest\x12\x1d\n" +
	"\n" +
	...
	"\abackend\x18\x04 \x01(\tR\abackend\"Q\n" +
	"\vOCRResponse\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\x12\x18\n" +
	"\abackend\x18\x03 \x01(\tR\abackend2\xce\x01\n" +
	"\tDocReader\x129\n" +
	"\x04Read\x12\x16.docreader.ReadRequest\x1a\x17.docreader.ReadResponse\"\x00\x12N\n" +
	"\vListEngines\x12\x1d.docreader.ListEnginesRequest\x1a\x1e.docreader.ListEnginesResponse\"\x00\x126\n" +
	"\x03OCR\x12\x15.docreader.OCRRequest\x1a\x16.docreader.OCRResponse\"\x00B5Z3github.com/Tencent/WeKnora/internal/docreader/protob\x06proto3"
...
var file_docreader_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_docreader_proto_goTypes = []any{
	...
	(*OCRRequest)(nil),          // 7: docreader.OCRRequest
	(*OCRResponse)(nil),         // 8: docreader.OCRResponse
	nil,                         // 9: docreader.ReadConfig.ParserEngineOverridesEntry
	nil,                         // 10: docreader.ReadResponse.MetadataEntry
	nil,                         // 11: docreader.ListEnginesRequest.ConfigOverridesEntry
}
var file_docreader_proto_depIdxs = []int32{
	...
	11, // 4: docreader.ListEnginesRequest.config_overrides:type_name -> docreader.ListEnginesRequest.ConfigOverridesEntry
	...
	7,  // 8: docreader.DocReader.OCR:input_type -> docreader.OCRRequest
	3,  // 9: docreader.DocReader.Read:output_type -> docreader.ReadResponse
	6,  // 10: docreader.DocReader.ListEngines:output_type -> docreader.ListEnginesResponse
	8,  // 11: docreader.DocReader.OCR:output_type -> docreader.OCRResponse
