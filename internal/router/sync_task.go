...
func RegisterSyncHandlers(params SyncTaskParams) {
	...
	params.Executor.RegisterHandler(types.TypeKBMaintenance, params.KnowledgeService.ProcessKBMaintenance)
	...
	params.Executor.RegisterHandler(types.TypeChunkTagSync, params.KnowledgeService.ProcessChunkTagSync)
	...
	params.Executor.RegisterHandler(types.TypeFeishuPublish, func(ctx context.Context, task *asynq.Task) error {
