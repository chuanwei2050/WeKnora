...
{{- $digest := default "" .Values.app.image.digest }}
{{- if $digest }}{{ printf "%s@%s" .Values.app.image.repository $digest }}{{ else }}{{ $tag := default .Chart.AppVersion .Values.app.image.tag }}{{ printf "%s:%s" .Values.app.image.repository $tag }}{{ end }}
{{- end }}
...
{{- if $digest }}{{ printf "%s@%s" .Values.frontend.image.repository $digest }}{{ else }}{{ printf "%s:%s" .Values.frontend.image.repository .Values.frontend.image.tag }}{{ end }}
{{- end }}
...
{{- $digest := default "" .Values.docreader.image.digest }}
{{- if $digest }}{{ printf "%s@%s" .Values.docreader.image.repository $digest }}{{ else }}{{ printf "%s:%s" .Values.docreader.image.repository .Values.docreader.image.tag }}{{ end }}
{{- end }}
...
{{- if $digest }}{{ printf "%s@%s" .Values.postgresql.image.repository $digest }}{{ else }}{{ printf "%s:%s" .Values.postgresql.image.repository .Values.postgresql.image.tag }}{{ end }}
{{- end }}
...
{{- $digest := default "" .Values.redis.image.digest }}
{{- if $digest }}{{ printf "%s@%s" .Values.redis.image.repository $digest }}{{ else }}{{ printf "%s:%s" .Values.redis.image.repository .Values.redis.image.tag }}{{ end }}
{{- end }}
